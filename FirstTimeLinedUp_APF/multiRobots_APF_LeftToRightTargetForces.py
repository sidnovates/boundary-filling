...
## Computes all Forces - (random exploration, robot repulsion, wall repulsion, and target attraction)
...
class Environment:
    ...
    def _init_target_points(self):
        ...
        if num_points <= 1:
            ...
            # Assign weights increasing linearly from 0.0 (left) to 1.0 (right)
            self.target_point_weights = [(i / (num_points - 1)) for i in range(num_points)]
